        ...
        try:
            ...
            if(len(data) != 0):
                ...
                if (Data[0] == "G00"):
                    ...
                    CONSTANT.DATA_G00["NODE32"]["time"]        = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
                    ...
                    CONSTANT.DATA_G01["NODE33"]["time"]        = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
                    CONSTANT.DATA_G01["NODE33"]["syn"]        =   "ok"
                else:
                    return False
